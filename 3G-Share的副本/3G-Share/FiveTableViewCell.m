...
//        _buttonThree.tintColor = [UIColor redColor];
        ...
        _imageViewOne = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"list_img4.png"]];
