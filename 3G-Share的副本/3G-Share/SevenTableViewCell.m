...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
   ...
   [_buttonOne setTitle:@"推荐" forState:UIControlStateNormal];
...
//    _buttonTwo.backgroundColor = newColor;
   [_buttonTwo setTitle:@"人气最高" forState:UIControlStateNormal];
...
//    _buttonThree.backgroundColor = newColor;
   ...
   [_buttonThree setTitle:@"收藏最多" forState:UIControlStateNormal];
...
//    _buttonFour.backgroundColor = newColor;
   ...
   [_buttonFour setTitle:@"评论最多" forState:UIControlStateNormal];
...
//    _buttonFive.backgroundColor = newColor;
   ...
   [_buttonFive setTitle:@"编辑精选" forState:UIControlStateNormal];
...
//    _buttonSix.backgroundColor = newColor;
   ...
   [_buttonSix setTitle:@"访问量" forState:UIControlStateNormal];
...
//    _buttonSeven.backgroundColor = newColor;
   ...
   [_buttonSeven setTitle:@"关于小司" forState:UIControlStateNormal];
